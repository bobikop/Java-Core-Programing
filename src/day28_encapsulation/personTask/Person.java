...
public class Person {
    ...
    public Person(String name, int age) { //Allow us to create Person object just by setting the name & age of the person
        this(name);
        this.age = age;
    }


    public Person(String name, String language) {//Allow us to create Person object just by setting the name & language of the person
        this(name);
    ...
    public Person(String name, int age, char gender) {
        this(name, age); // we can call only one contractor inside another
        this.gender = gender;
    }
