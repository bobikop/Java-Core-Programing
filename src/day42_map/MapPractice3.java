...
public class MapPractice3 {
    public static void main(String[] args) {
        ...
        //this is example how to store Map un to array



        Map<String, Object>[] arrayOfMap = new Map[5]; // index : 0 ~ 4
        // data type of the array define what kind of data type can be stored
        ...
        arrayOfMap[1].replace("salary",((Integer)arrayOfMap[1].get("salary")) + 1000);
