...
public class MapTask5 {
    public static void main(String[] args) {
        ...
        // 3.1 Create map that has integer as keys and List of Strings as values add the group number and students name of that group as a pair to the map
        ...
        for (Map.Entry<Integer, List<String>> eachListEntry : map.entrySet()) {
            System.out.println(eachListEntry.getValue());
        }
