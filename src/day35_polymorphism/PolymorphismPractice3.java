...
public class PolymorphismPractice3 {
    ...
    public static void main(String[] args) {
        ...
        for (Employee each : employees){
            System.out.println(each.getName() + " " + each.getJobTitle()); // will print all employee name and job title form array
        }
        ...
        countTester = 0,
        countDriver = 0, countTeachers = 0;

       for (Employee each : employees){
           if(each instanceof Developer){ // check and print which employee are Developers
               countDeveloper++;
           } else if (each instanceof Tester) {// check and print which employee are Testers
               countTester++;
           } else if (each instanceof Teacher) {// check and print which employee are Teacher
               countTeachers++;
           }else{
               countDriver++;
           }
        ...
        System.out.println("countTeacher = " + countTeachers);
